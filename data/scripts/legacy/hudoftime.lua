...
zelda.HEART_FULL = Graphics.loadImage(getSMBXPath().."\\scripts\\Legacy\\hudoftime\\heart_full.png");
zelda.HEART_EMPT = Graphics.loadImage(getSMBXPath().."\\scripts\\Legacy\\hudoftime\\heart_empty.png");
zelda.RUPEE = Graphics.loadImage(getSMBXPath().."\\scripts\\Legacy\\hudoftime\\rupee.png");
zelda.SWORD = Graphics.loadImage(getSMBXPath().."\\scripts\\Legacy\\hudoftime\\sword.png");
zelda.BOMB = Graphics.loadImage(getSMBXPath().."\\scripts\\Legacy\\hudoftime\\bomb.png");
zelda.BTN_X = Graphics.loadImage(getSMBXPath().."\\scripts\\Legacy\\hudoftime\\btn_X.png");
zelda.BTN_S = Graphics.loadImage(getSMBXPath().."\\scripts\\Legacy\\hudoftime\\btn_S.png");
zelda.KEY = Graphics.loadImage(getSMBXPath().."\\scripts\\Legacy\\hudoftime\\small_key.png");
zelda.MAGIC_BG = Graphics.loadImage(getSMBXPath().."\\scripts\\Legacy\\hudoftime\\magic_bg.png");
zelda.MAGIC_BAR = Graphics.loadImage(getSMBXPath().."\\scripts\\Legacy\\hudoftime\\magic_bar.png");
zelda.NAVI = Graphics.loadImage(getSMBXPath().."\\scripts\\Legacy\\hudoftime\\navi.png");
zelda.TRIFORCE = Graphics.loadImage(getSMBXPath().."\\scripts\\Legacy\\hudoftime\\stars.png");
zelda.FAIRY = Graphics.loadImage(getSMBXPath().."\\scripts\\Legacy\\hudoftime\\lives.png");
...
local function UpdateNavi()
	...
	for _,v in ipairs(NPC.getIntersecting(player.x,player.y,player.x+player.width,player.y+player.height)) do
		if(v:mem(0x46,FIELD_WORD) == -1 --[[Friendly]] and (v:mem(0x4C,FIELD_DWORD) > 0 and v.msg ~= "") --[[Has message]]) then
			zelda.navi = true;
			break;
		end
	end
