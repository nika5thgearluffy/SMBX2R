...
npcManager.registerHarmTypes(npcID,
	...
	{
		--[HARM_TYPE_JUMP]=10,
		[HARM_TYPE_FROMBELOW]={id = 311, xoffsetBack = 0, yoffsetBack = 0},
		[HARM_TYPE_NPC]={id = 311, xoffsetBack = 0, yoffsetBack = 0},
		[HARM_TYPE_PROJECTILE_USED]={id = 311, xoffsetBack = 0, yoffsetBack = 0},
		[HARM_TYPE_LAVA]={id=13, xoffset=0.5, xoffsetBack = 0, yoffset=1, yoffsetBack = 1.5},
		--[HARM_TYPE_HELD]=10,
		[HARM_TYPE_TAIL]={id = 311, xoffsetBack = 0, yoffsetBack = 0},
		--[HARM_TYPE_SPINJUMP]=10,
		--[HARM_TYPE_OFFSCREEN]=10,
		[HARM_TYPE_SWORD]={id = 311, xoffsetBack = 0, yoffsetBack = 0},
	}
);
