...
local greenGrinderSettings = table.join({id = npcID, speed = 3}, grinders.sharedGrinderSettings)
npcManager.setNpcSettings(greenGrinderSettings)
lineguide.properties[npcID] = table.join({lineSpeed = 3}, grinders.sharedGrinderLineguideProps)
