...
local greenGrinderSettings = table.join({id = npcID, speed = 4}, grinders.sharedGrinderSettings)
npcManager.setNpcSettings(greenGrinderSettings)
lineguide.properties[npcID] = table.join({lineSpeed = 4}, grinders.sharedGrinderLineguideProps)
